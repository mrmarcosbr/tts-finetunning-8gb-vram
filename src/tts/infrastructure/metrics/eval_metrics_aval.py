...
from tts.infrastructure.audio.trained_post_eq import apply_trained_output_waveform_eq, trained_eq_affects_audio
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    if not args.skip_f0:
        from tts.infrastructure.metrics.f0_infer_metrics import summarize_f0_rmse_inference
